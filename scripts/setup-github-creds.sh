...
echo ""
echo "4. Webhooks are registered automatically when users link a repo in production."
echo "   Local dev skips webhook registration because GitHub cannot reach localhost."
echo ""
